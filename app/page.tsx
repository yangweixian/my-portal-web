...
export default function Home() {
  return (
    <div className="flex flex-col lg:flex-row h-screen bg-[#F8F9FA] font-sans text-gray-800 lg:gap-8 lg:items-start">
      {/* Left Column: Main Content */}
      <div className="lg:w-[70%] lg:h-screen lg:overflow-y-auto">
        <main className="w-[95%] max-w-[1440px] mx-auto pt-4 pb-12 space-y-10">
      ...
      <div className="hidden lg:block lg:w-[30%] lg:h-full p-4">
        <div
          id="coze-container"
          className="w-full h-full rounded-2xl shadow-lg border border-gray-200 overflow-hidden"
        >
          {/* Coze Agent will be mounted here */}
        </div>
      </div>

      {/* Coze Agent Component - handles logic for both mobile and desktop */}
      <CozeAgent />
    </div>
  );
}
